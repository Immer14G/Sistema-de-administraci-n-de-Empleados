    ...
    // Consulta SQL para obtener empleados y su profesión
    try {
        $sql = "SELECT id, nombre, profesion FROM empleados";
    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <a href="listarDepartamentos.php" class="nav-link">Departamentos</a>
        ...
        <div class="main-content">
            <h2 class="text-center mb-4">Lista de Empleados y Profesiones</h2>
